...
def pytest_addoption(parser):
    """ Allows us to add --runslow as an argument to pytest so we can run tests marked slow """
    parser.addoption("--runslow", action="store_true", help="run slow tests")


def pytest_runtest_setup(item):
    """ Skip tests marked 'slow' unless we explicitly asked to run them """
...
def app():
    ...
    See: http://flask.pocoo.org/docs/latest/reqcontext/
    """
